...
const Profile = () => {
  ...
  const updateProfile = async () => {
    try {
      ...
      // For example:
      // await appServices.updateProfile(data);
  ...
  if (error && !error.toString().includes("Profile not found")) {
    return (
      <DashboardLayout>
      ...
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
          ...
          <button
            ...
            className="px-6 py-3 text-white bg-[#0D55A3] rounded-lg hover:bg-[#0D55A3]/90 transition-colors flex items-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="px-4 py-2 text-white bg-[#0D55A3] rounded-lg hover:bg-[#0D55A3]/90 transition-colors flex items-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="none"
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  <img
                    ...
                    alt="Profile"
                    className="w-32 h-32 p-2 rounded-full object-cover border-4 border-[#0D55A3]"
                  />
                </div>
                ...
                <div className="border-b border-gray-200 pb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <DatePicker
                        selected={new Date(editFormData.birth_date)}
                        onChange={(date) =>
                          handleEditChange({
                            target: {
                              name: "birth_date",
